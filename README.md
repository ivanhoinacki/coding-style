...
Every project should contain a [.editorconfig](https://github.com/ivanhoinacki/coding-style/blob/master/.editorconfig) file that automatically set some indentation definitions. Make sure to install [Editor Config's](http://editorconfig.org/) plugin on your code editor and you'll be all set.
...
The options for JSHint are stored in a [.jshintrc](https://github.com/ivanhoinacki/coding-style/blob/master/.jshintrc) file.
